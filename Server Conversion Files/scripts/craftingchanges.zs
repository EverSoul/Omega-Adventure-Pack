...
recipes.removeShaped(<divinerpg:diamondHelmet>);
recipes.removeShaped(<divinerpg:diamondChestplate>);
recipes.removeShaped(<divinerpg:diamondLeggings>);
recipes.removeShaped(<divinerpg:diamondBoots>);
recipes.removeShaped(<divinerpg:ironHelmet>);
recipes.removeShaped(<divinerpg:ironChestplate>);
recipes.removeShaped(<divinerpg:ironLeggings>);
recipes.removeShaped(<divinerpg:ironBoots>);
...
recipes.addShaped(<divinerpg:diamondHelmet>,[[<minecraft:diamond>,<minecraft:diamond>,<minecraft:diamond>],[<minecraft:diamond>,<minecraft:glass>,<minecraft:diamond>],[null,null,null]]);
recipes.addShaped(<divinerpg:diamondChestplate>,[[<minecraft:diamond>,<minecraft:glass>,<minecraft:diamond>],[<minecraft:diamond>,<minecraft:diamond>,<minecraft:diamond>],[diamond,diamond,diamond]]);
recipes.addShaped(<divinerpg:diamondLeggings>,[[<minecraft:diamond>,<minecraft:diamond>,<minecraft:diamond>],[<minecraft:diamond>,<minecraft:glass>,<minecraft:diamond>],[diamond,null,diamond]]);
recipes.addShaped(<divinerpg:diamondBoots>,[[<minecraft:diamond>,<minecraft:glass>,<minecraft:diamond>],[<minecraft:diamond>,null,<minecraft:diamond>],[null,null,null]]);
recipes.addShaped(<divinerpg:ironHelmet>,[[iron,iron,iron],[iron,<minecraft:glass>,iron],[null,null,null]]);
recipes.addShaped(<divinerpg:ironChestplate>,[[iron,<minecraft:glass>,iron],[iron,iron,iron],[iron,iron,iron]]);
recipes.addShaped(<divinerpg:ironLeggings>,[[iron,iron,iron],[iron,<minecraft:glass>,iron],[iron,null,iron]]);
recipes.addShaped(<divinerpg:ironBoots>,[[iron,<minecraft:glass>,iron],[iron,null,iron],[null,null,null]]);
